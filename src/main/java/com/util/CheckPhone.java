...
public class CheckPhone {
	...
	/**
	 * 中国联通号码格式验证 手机段：130,131,132,155,156,185,186,145,176,175,1707,1708,1709
	 * **/
	 ...
	 * 仅手机号格式校验
	 */
	private static final String PHONE_PATTERN = new StringBuilder(300).append(CHINA_MOBILE_PATTERN).append("|").append(CHINA_TELECOM_PATTERN).append("|")
			.append(CHINA_UNICOM_PATTERN).toString();

	/**
	 * 手机和座机号格式校验
	 */
	private static final String PHONE_TEL_PATTERN = new StringBuilder(350).append(PHONE_PATTERN).append("|").append("(").append(PHONE_CALL_PATTERN).append(")")
			.toString();
	...
	public static void main(String[] args) {
		System.out.println(CheckPhone.isPhone("0452"));
	}
