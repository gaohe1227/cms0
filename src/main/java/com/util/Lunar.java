...
public class Lunar {
	...
	// ----Mine----
	public static final String[] TIANGAN = { "己", "庚", "辛", "壬", "癸", "甲", "乙", "丙", "丁", "戊" };

	public static final String[] DIZHI = { "未", "申", "酉", "戌", "亥", "子", "丑", "寅", "卯", "辰", "巳", "午" };

	public static Logger logger = Logger.getLogger(Lunar.class);
